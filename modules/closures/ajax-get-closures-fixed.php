<?php
/**
 * AJAX: Obtener historial de cierres - Versiu00f3n corregida
 */
public function ajax_get_closures() {
    ...
    // Paroi1metros de filtrado y paginacioi1n
    ...
    // Ordenar por fecha (moi1s reciente primero)
    $query .= " ORDER BY c.created_at DESC";
    
    // Aplicar paginacioi1n
